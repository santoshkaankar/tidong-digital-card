...
Route::middleware(['web', 'auth'])->prefix('hub')->name('hub.')->group(function () {
    ...
    Route::prefix('restaurant')->name('restaurant.')->group(function () {
        ...
        // Yahan 'order.place' ko badal kar 'placeOrder' kar diya gaya hai:
        Route::post('/order/place', [RestaurantController::class, 'placeOrder'])->name('placeOrder');
    });
