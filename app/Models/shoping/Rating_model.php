            ...
            if (!empty($row['images'])) {
                ...
                for ($j = 0; $j < count($images); $j++) {
                    ...
                    if ($j == 0) {
                        ...
                        $tempRow['images'] = '<div class="row"><div class="col-md-6"><div class="mx-auto image-box-table"><a href="' . $image_url . '" data-lightbox="' . $image_unique_name . '"> <img src="' . $image_url . '" class="img-fluid rounded"> </a></div></div><div class="col-md-6 my-auto "> <span class="text-primary"> ' . $counter . '</span></div></div>';
                    } else {
                        $tempRow['images'] .= '<div class="mx-auto image-box-table d-none"><a href="' . $image_url . '" data-lightbox="' . $image_unique_name . '"><img src="' . $image_url . '" class="img-fluid rounded"></a></div>';
                    }
                }
            } else {
                $tempRow['images'] = '-';
