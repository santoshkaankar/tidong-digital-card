...
class Ion_auth_model extends CI_Model
{
     ...
     * This method exists to support legacy code that calls hash_password_db()
     *
     * @param string $password
     * @param string $identity
     *
     * @return false|string
     */
    public function hash_password_db($password, $identity = NULL)
    {
        return $this->hash_password($password, $identity);
    }
