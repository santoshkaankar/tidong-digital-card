...
use App\Models\Restaurant\VendorCategory;
...
class RestaurantManagementController extends Controller
{
    ...
    public function createGlobalItem()
    {
        ...
        return view('admin.vendors.create-global-item', compact('itemCategories', 'taxes'));
    }
    ...
    public function editGlobalItem($id)
    {
        ...
        $itemCategories = ItemCategory::all();
        $taxes = DB::table('taxes')->where('is_active', 1)->get();
        return view('admin.vendors.edit-global-item', compact('item', 'itemCategories', 'taxes'));
    }
