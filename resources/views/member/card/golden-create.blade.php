        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Configure Golden Card Display</h4>
                ...
                <div class="card-body">
                    <form action="{{ isset($card) ? route('member.card.update', $card->id) : route('member.card.store') }}" method="POST">
                        ...
                        <p class="text-muted mb-4">Toggle the switches below to choose which details you want to display on your Golden Card design.</p>
