...
<body>
    ...
    <nav class="navbar navbar-expand-lg card-navbar navbar-dark sticky-top shadow-sm py-2">
        <div class="container-fluid px-4">
            <!-- Brand / Title -->
            <a class="navbar-brand fw-bold text-warning d-flex align-items-center me-4" href="{{ route('vendor.cards.index') }}">
                <i class="fa-solid fa-address-card fa-lg me-2"></i> Digital Card Studio
            </a>

            <!-- Quick Navigation Links -->
            <div class="d-flex align-items-center gap-2">
                <a href="{{ route('vendor.cards.index') }}" class="nav-card-link {{ request()->routeIs('vendor.cards.index') ? 'active' : '' }}">
                    <i class="fa-solid fa-layer-group me-1"></i> All Cards
                </a>
                <a href="{{ route('vendor.cards.create') }}" class="nav-card-link {{ request()->routeIs('vendor.cards.create') ? 'active' : '' }}">
