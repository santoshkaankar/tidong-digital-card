...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            @php
                $businessType = strtolower(Auth::user()->business_type ?? 'taxi');
            ...
            @if($businessType == 'food')
                ...
                <li><a href="{{ route('vendor.categories.index') }}" class="{{ request()->routeIs('vendor.categories.index') ? 'active' : '' }}"><i class="fas fa-tags"></i> Add Category</a></li>
                <li><a href="{{ route('vendor.inventory.index') }}" class="{{ request()->routeIs('vendor.inventory.index') ? 'active' : '' }}"><i class="fas fa-boxes"></i> Add Item</a></li>
                <li><a href="javascript:void(0)" onclick="openRequestModal()"><i class="fas fa-plus-circle"></i> Request New Item</a></li>
                <li><a href="{{ route('vendor.pricing.index') }}" class="{{ request()->routeIs('vendor.pricing.index') ? 'active' : '' }}"><i class="fas fa-rupee-sign"></i> Add Price</a></li>
                <li><a href="{{ route('vendor.catalogs.index') }}" class="{{ request()->routeIs('vendor.catalogs.index') ? 'active' : '' }}"><i class="fas fa-book-open"></i> Catalog</a></li>
                <li class="menu-section-title">QR & TABLES</li>
                <li><a href="{{ route('vendor.qrcode') }}" class="{{ request()->routeIs('vendor.qrcode') ? 'active' : '' }}"><i class="fas fa-qrcode"></i> Table QR Code</a></li>
            
            @elseif($businessType == 'taxi')
                <li class="menu-section-title">TAXI & DRIVER OPS</li>
                <li><a href="{{ route('vendor.taxi.activeRides') }}" class="{{ request()->routeIs('vendor.taxi.activeRides') ? 'active' : '' }}"><i class="fas fa-route text-warning"></i> Active Rides</a></li>
                <li><a href="{{ route('vendor.taxi.rideHistory') }}" class="{{ request()->routeIs('vendor.taxi.rideHistory') ? 'active' : '' }}"><i class="fas fa-history"></i> Ride History</a></li>
                <li><a href="{{ route('vendor.taxi.vehicleDocs') }}" class="{{ request()->routeIs('vendor.taxi.vehicleDocs') ? 'active' : '' }}"><i class="fas fa-car-side"></i> Vehicle Documents</a></li>

            @elseif($businessType == 'money_exchange')
                <li class="menu-section-title">FX CURRENCY OPS</li>
                <li><a href="{{ route('vendor.exchange.rates') }}" class="{{ request()->routeIs('vendor.exchange.rates') ? 'active' : '' }}"><i class="fas fa-coins text-success"></i> Exchange Rates Master</a></li>

            @elseif($businessType == 'emporium')
                <li class="menu-section-title">EMPORIUM SHOWCASE</li>
                <li><a href="{{ route('vendor.categories.index') }}" class="{{ request()->routeIs('vendor.categories.index') ? 'active' : '' }}"><i class="fas fa-tags"></i> Craft Categories</a></li>
                <li><a href="{{ route('vendor.inventory.index') }}" class="{{ request()->routeIs('vendor.inventory.index') ? 'active' : '' }}"><i class="fas fa-gem text-info"></i> Souvenir Items</a></li>
                <li><a href="javascript:void(0)" onclick="openRequestModal()"><i class="fas fa-plus-circle"></i> Request New Item</a></li>
                <li><a href="{{ route('vendor.catalogs.index') }}" class="{{ request()->routeIs('vendor.catalogs.index') ? 'active' : '' }}"><i class="fas fa-store"></i> Digital Showcase</a></li>
                <li><a href="{{ route('vendor.qrcode') }}" class="{{ request()->routeIs('vendor.qrcode') ? 'active' : '' }}"><i class="fas fa-qrcode"></i> Store QR Standee</a></li>

            @elseif($businessType == 'guide')
                <li class="menu-section-title">TOURIST GUIDE OPS</li>
                <li><a href="{{ route('vendor.guide.bookings') }}" class="{{ request()->routeIs('vendor.guide.bookings') ? 'active' : '' }}"><i class="fas fa-flag text-danger"></i> Tour Bookings</a></li>
            @endif

            <li class="menu-section-title">OPERATIONS</li>
            <li>
                <a href="{{ route('vendor.taxi.bookings') }}" class="{{ request()->routeIs('vendor.taxi.bookings') ? 'active' : '' }}"><i class="fas fa-shopping-cart"></i> Booking / Orders</a>
            </li>
            <li>
                <a href="{{ route('vendor.taxi.payments') }}" class="{{ request()->routeIs('vendor.taxi.payments') ? 'active' : '' }}"><i class="fas fa-wallet"></i> Payment Status</a>
            </li>
            ...
            @if($businessType == 'taxi')
                <div class="card-box border-start border-4 border-warning mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form method="POST" action="{{ route('vendor.duty.status') }}">
                            @csrf
                            <button type="submit" class="btn btn-success fw-bold"><i class="fas fa-power-off me-1"></i> Switch ONLINE</button>
                        </form>
                    </div>
                </div>
            @elseif($businessType == 'money_exchange')
                <div class="card-box border-start border-4 border-success mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('vendor.exchange.rates') }}" class="btn btn-primary fw-bold btn-sm"><i class="fas fa-sync me-1"></i> Update FX Rates</a>
                    </div>
                </div>
            @endif
