        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Order Confirmation & Invoice</li>
                </ol>
            </nav>
            <h2 class="fw-bold text-dark mb-0"><i class="fas fa-check-circle text-primary me-2"></i> Order Confirmation & Invoice</h2>
        </div>
        <div>
    ...
    <div class="row g-4">
        <div class="col-lg-12">
            <div class="card shadow-sm border-0 rounded-4 p-4">
                <div class="mb-3">
                    <span class="badge bg-primary-subtle text-primary px-3 py-2 rounded-pill fw-semibold">Feature Module: order-success</span>
                </div>
                <h5 class="fw-bold text-secondary mb-3">Module Overview</h5>
                <p class="text-muted lh-lg">Order ID, delivery estimate, item breakdown, and invoice download option.</p>
