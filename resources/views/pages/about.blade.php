...
<head>
    ...
    <style>
        ...
        .leadership-card { background: #fff; border-radius: 12px; border: 1px solid #e2e8f0; padding: 20px; height: 100%; text-align: center; }
    </style>
...
<body>
    ...
    <div class="container py-5">
        ...
        <h3 class="fw-bold text-dark text-center mb-4">Leadership & Corporate Governance</h3>
        <div class="row g-4 mb-5">
            <div class="col-md-3">
                <div class="leadership-card shadow-sm">
                    <i class="fas fa-user-tie fa-2x text-primary mb-3"></i>
                    <h5 class="fw-bold mb-1">Meenu Sharma</h5>
                    <p class="text-primary small fw-semibold mb-2">Director / Chairperson</p>
                    <p class="text-muted small mb-0">Leading board governance and strategic corporate vision.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="leadership-card shadow-sm">
                    <i class="fas fa-user-shield fa-2x text-success mb-3"></i>
                    <h5 class="fw-bold mb-1">Santosh Kumar Sharma</h5>
                    <p class="text-success small fw-semibold mb-2">Director / CEO</p>
                    <p class="text-muted small mb-0">Driving platform architecture and international operations.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="leadership-card shadow-sm">
                    <i class="fas fa-balance-scale fa-2x text-warning mb-3"></i>
                    <h5 class="fw-bold mb-1">Adv. Rajkumar Rawat</h5>
                    <p class="text-warning small fw-semibold mb-2">Legal Advisor</p>
                    <p class="text-muted small mb-0">Managing corporate legal frameworks and compliance.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="leadership-card shadow-sm">
                    <i class="fas fa-calculator fa-2x text-danger mb-3"></i>
                    <h5 class="fw-bold mb-1">CA Bhavna Solanki</h5>
                    <p class="text-danger small fw-semibold mb-2">Chartered Accountant</p>
                    <p class="text-muted small mb-0">Overseeing financial auditing, taxation, and accounts.</p>
                </div>
            </div>
        </div>
