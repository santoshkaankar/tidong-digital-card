            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-taxi"></i></div>
                        <h2 class="fw-bold text-dark">Taxi Booking Guide</h2>
                        <p class="text-muted">How to manage vendor bookings for local cab and taxi rides.</p>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="mt-5 text-center">
                        <a href="{{ route('vendor.taxi.rides') }}" class="btn btn-primary px-4 rounded-pill">
