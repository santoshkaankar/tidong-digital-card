            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-share-square"></i></div>
                        <h2 class="fw-bold text-dark">WhatsApp Direct Share</h2>
                        <p class="text-muted">Feature to send your card link directly to clients on WhatsApp with a single click.</p>
                    </div>
                    <hr class="my-4">
