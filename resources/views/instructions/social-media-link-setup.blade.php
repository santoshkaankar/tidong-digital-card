            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-share-alt"></i></div>
                        <h2 class="fw-bold text-dark">Social Media Link Setup</h2>
                        <p class="text-muted">Attach Facebook, Instagram, LinkedIn, and Twitter profile links to your card.</p>
                    </div>
                    <hr class="my-4">
