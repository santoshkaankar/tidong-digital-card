            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-tags"></i></div>
                        <h2 class="fw-bold text-dark">Catalog Pricing (MRP/Sale)</h2>
                        <p class="text-muted">Guide to set custom retail sale prices and discounts on your products.</p>
                    </div>
                    <hr class="my-4">
