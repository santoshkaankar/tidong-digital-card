            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-question-circle"></i></div>
                        <h2 class="fw-bold text-dark">Quick FAQ Access</h2>
                        <p class="text-muted">Find answers to frequently asked questions right here.</p>
                    </div>
                    <hr class="my-4">
