            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-phone-alt"></i></div>
                        <h2 class="fw-bold text-dark">Direct Calling Integration</h2>
                        <p class="text-muted">Feature allowing card viewers to place a direct phone call with one click.</p>
                    </div>
                    <hr class="my-4">
