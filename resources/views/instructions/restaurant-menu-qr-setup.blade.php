            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-utensils"></i></div>
                        <h2 class="fw-bold text-dark">Restaurant Menu QR Setup</h2>
                        <p class="text-muted">Guide to generate digital menus and table QR codes for your food outlet.</p>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="mt-5 text-center">
                        <a href="{{ route('guidance.restaurant') }}" class="btn btn-primary px-4 rounded-pill">
