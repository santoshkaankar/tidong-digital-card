            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-user-edit"></i></div>
                        <h2 class="fw-bold text-dark">Update Profile Picture</h2>
                        <p class="text-muted">Method to edit your account profile photo and personal information.</p>
                    </div>
                    <hr class="my-4">
