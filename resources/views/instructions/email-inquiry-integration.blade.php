            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-envelope-open"></i></div>
                        <h2 class="fw-bold text-dark">Email Inquiry Integration</h2>
                        <p class="text-muted">Add a direct email contact link to your digital visiting card.</p>
                    </div>
                    <hr class="my-4">
