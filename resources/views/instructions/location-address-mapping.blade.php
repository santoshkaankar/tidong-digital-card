            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-map-marker-alt"></i></div>
                        <h2 class="fw-bold text-dark">Location & Address Mapping</h2>
                        <p class="text-muted">Embed Google Map location links onto your visiting card or store profile.</p>
                    </div>
                    <hr class="my-4">
