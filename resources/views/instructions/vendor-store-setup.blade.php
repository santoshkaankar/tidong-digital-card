            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-store"></i></div>
                        <h2 class="fw-bold text-dark">Vendor Store Setup</h2>
                        <p class="text-muted">Register your shop or retail business online and list your products.</p>
                    </div>
                    <hr class="my-4">
