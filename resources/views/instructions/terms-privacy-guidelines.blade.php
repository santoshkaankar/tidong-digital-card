            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-shield-alt"></i></div>
                        <h2 class="fw-bold text-dark">Terms & Privacy Guidelines</h2>
                        <p class="text-muted">Information regarding company legal terms, conditions, and user privacy policies.</p>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="mt-5 text-center">
                        <a href="{{ route('pages.terms') }}" class="btn btn-primary px-4 rounded-pill">
