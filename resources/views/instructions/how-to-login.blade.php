            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-sign-in-alt"></i></div>
                        <h2 class="fw-bold text-dark">How to Login?</h2>
                        <p class="text-muted">Step-by-step guide to securely log in to the portal using your mobile number or email.</p>
                    </div>
                    <hr class="my-4">
