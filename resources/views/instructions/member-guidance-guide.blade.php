            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-book-reader"></i></div>
                        <h2 class="fw-bold text-dark">Member Guidance Guide</h2>
                        <p class="text-muted">Complete handbook for new members to understand all platform features.</p>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="mt-5 text-center">
                        <a href="{{ route('guidance.member') }}" class="btn btn-primary px-4 rounded-pill">
