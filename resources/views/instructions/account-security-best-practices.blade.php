            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-lock"></i></div>
                        <h2 class="fw-bold text-dark">Account Security Best Practices</h2>
                        <p class="text-muted">Important suggestions to keep your password and account secure.</p>
                    </div>
                    <hr class="my-4">
