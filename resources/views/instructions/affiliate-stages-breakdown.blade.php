            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-sitemap"></i></div>
                        <h2 class="fw-bold text-dark">Affiliate Stages Breakdown</h2>
                        <p class="text-muted">Complete list of different affiliate levels and their commission milestones.</p>
                    </div>
                    <hr class="my-4">
