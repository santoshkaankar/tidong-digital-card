            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="fw-bold text-dark">Create Digital Visiting Card</h2>
                        <p class="text-muted">Guide to design an interactive visiting card for your personal or business ID.</p>
                    </div>
                    <hr class="my-4">
