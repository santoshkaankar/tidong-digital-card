            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-sign-out-alt"></i></div>
                        <h2 class="fw-bold text-dark">Secure Logout Process</h2>
                        <p class="text-muted">Safely log out from your account and close your session.</p>
                    </div>
                    <hr class="my-4">
