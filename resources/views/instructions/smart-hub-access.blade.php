            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="fw-bold text-dark">Smart Hub Access</h2>
                        <p class="text-muted">Method to access hub features using universal QR codes without downloading any app.</p>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="mt-5 text-center">
                        <a href="{{ route('customer.hub') }}" class="btn btn-primary px-4 rounded-pill">
