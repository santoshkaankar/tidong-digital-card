            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-gift"></i></div>
                        <h2 class="fw-bold text-dark">Lucky Draw Bonanza Offer</h2>
                        <p class="text-muted">Process to participate in lucky draw bonanza offers and check the winners list.</p>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="mt-5 text-center">
                        <a href="{{ route('pages.luckydrow') }}" class="btn btn-primary px-4 rounded-pill">
