            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="display-4 text-primary mb-3"><i class="fas fa-bell"></i></div>
                        <h2 class="fw-bold text-dark">Notification Alerts Setting</h2>
                        <p class="text-muted">Settings to receive important platform alerts and updates on your device.</p>
                    </div>
                    <hr class="my-4">
